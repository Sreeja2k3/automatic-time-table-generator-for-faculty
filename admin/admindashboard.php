...
<a href="logout.php"><font color="#FFFFFF">Logout</font></a></span>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="background-color:#000">
                    ...
                    <li>
                        <a href="admindashboard.php?info=add_timetable"><i class="fa fa-fw fa-wrench"></i>Time Table Generator</a>
                    </li>
					<li>
                        <a href="http://localhost/scheduling/admin/login.php"><i class="fa fa-fw fa-wrench"></i>Time Tables Schedule</a>
                    </li>
            ...
            <div class="container-fluid">
				...
				?>
                   ...
                   <font color="#FF3333" size="+3" face="Lucida Console, Monaco, monospace">Admin Panel</font><br/>
                        <img src="img/mrcet_logo.jpg" class="img-responsive" alt="Cinque Terre" width="250" height="250" style="                          margin-top: 70px; margin-left: 23px;">
                <?php }?>
